...
FOP have been implemented using both programming 
...
of a product line of expression evaluators (the Expression Product Line (EPL)). 
Figure~\ref{} shows the EPL feature model. Regarding our design decisions, 
in this case we implement the mandatory features using a \textsc{base} AHEAD package (Figure~\ref{fig:epl-base}), which
...
that an AHEAD package contains either plain Java class or interface declarations or refinements, which 
