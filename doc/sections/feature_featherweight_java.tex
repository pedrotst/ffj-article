...
The override function in Table \Cref{table:override} inductively guarantees that a method 
...
Every class and refinement of a \gls{FFJ+} program is assumed to respect the well-formedness rules
