...
The syntax of \ac{FFJ+} constructs is given at Table~\ref{abstractsyntax}. Metavariables
...
The override function in Table~\ref{table:override} inductively guarantees that a method 
...
Every class and refinement of a \ac{FFJ+} program is assumed to respect the well-formedness rules
defined in Table~\ref{table:classtyping}.
